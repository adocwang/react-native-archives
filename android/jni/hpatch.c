...
#include "hpatch.h"
#include "../../easypush/HDiffPatch/libHDiffPatch/HPatch/patch.h"
#include "../../easypush/HDiffPatch/file_for_patch.h"
...
#include "../../easypush/lzma/C/LzmaDec.h"
#include "../../easypush/lzma/C/Lzma2Dec.h"
#include "../../easypush/HDiffPatch/decompress_plugin_demo.h"
...
static int hpatch_by_stream(const hpatch_TStreamInput* old,hpatch_BOOL isLoadOldAllToMem,const hpatch_TStreamInput* pat,
    ...
    _check(patch_single_compressed_diff(out_new,old,pat,patInfo->diffDataPos,
               patInfo->uncompressedSize,patInfo->compressedSize,decompressPlugin,patInfo->coverCount,
               (size_t)patInfo->stepMemSize,temp_cache,temp_cache+temp_cache_size,0),kHPatch_error_patch);
